package com.greisssolutions.services;
...
public class AppModule {
    ...
    public void contributeApplicationStateManager(MappedConfiguration<Class, ApplicationStateContribution> configuration) {
        ApplicationStateCreator<Readings> creator = new ApplicationStateCreator<Readings>() {
            public Readings create() {
                Readings readings = new Readings();
                List data = session.createCriteria(Reading.class).list();
                readings.setReadings(new ArrayList<>());
                for(Object r : data) {
                    readings.getReadings().add((Reading)r);
                }
                return readings;
            }
        };

        configuration.add(Readings.class, new ApplicationStateContribution("session", creator));
    }
    ...
    public static void contributeApplicationDefaults(
        ...
        configuration.add(SymbolConstants.HMAC_PASSPHRASE, "sjkjkfwehkfekjhfkjwerhfkwerfhkwfhkmcnkdjwherwf,mcwdkchewk");
    }
